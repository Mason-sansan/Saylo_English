...
export function finalizeSessionGrowthMoves(report) {
  ...
  const capped = capMovesByNetOverallStep(withConf, GROWTH_NET_OVERALL_CAP);
 ...
 */
export function wrapQuickReportWithLegacy(quick, metrics, transcript = '') {
  const q = quick;
  ...
  const capped = capMovesByNetOverallStep(preCap, GROWTH_NET_OVERALL_CAP);
